...
If you already signed up, you can just log-in to MotherDuck, otherwise you can create an account on the https://motherduck.com/[homepage^] (via Google, GitHub or email auth).
...
Currently it takes about a minute to create the share, but in the future it will be a zero-copy operation.
