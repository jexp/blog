...
image::https://github.com/gunnarmorling/1brc/blob/main/1brc.png[]
...
Die Analyse erzeugt dann eine Ausgabe wie in Listing {counter:listing} zu sehen (hier für die Implementierung von Listing {listing-2}).
...
Was hat Dich beim 1BRC am meisten überrascht?

Mit welcher minimalen Laufzeit hattest Du für Java gerechnet?

Hättest Du Lust das nächstes Jahr zu wiederholen, diesmal mit Hilfe von der Community, könnte eine gute Ergänzug zu Advent of Code sein?

Hast Du Feedback vom JVM Team bekommen, neben den exzellenten Beiträgen von Thomas Wuerthinger?
