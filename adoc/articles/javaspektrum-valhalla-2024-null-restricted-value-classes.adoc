...
Daher ist es notwendig an diesen stellen durchgängig Unveränderlichkeit zu garantieren.
...
Das wird durch [JEP482] ermöglicht, der sich mit mehr Möglichkeiten von Konstruktoren (Code vor den Superklassen-Konstruktor-Aufrufen).
Die Idee ist zum einen die Sichbarkeit dieser unvollständigen Objekte zu verhindern (mittels DA - "Definite Assignment" Analyse), bzw. vorzeitig zu befüllen, bevor der Konstruktor der Superklasse aufgerufen wird.
